...
const createSendToken = (user, statusCode, res) => {
  ...
  //Remove the password field from newly created document
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // 4) Check if user changed password after the token is generated
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  // 2) Check if POSTed currPassword is correct
